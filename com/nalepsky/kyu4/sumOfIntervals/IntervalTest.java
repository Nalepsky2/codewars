...
import static com.nalepsky.kyu4.sumOfIntervals.Interval.sumIntervals;
...
public class IntervalTest {
    ...
    public void shouldAddDisjoinedIntervals() {
        assertEquals(9, sumIntervals(new int[][]{{1, 2}, {6, 10}, {11, 15}})); //1, 4, 4
    ...
    public void shouldAddOverlappingIntervals() {
        assertEquals(7, sumIntervals(new int[][]{{1, 4}, {7, 10}, {3, 5}})); //1-5 7-10 => 4 + 3
